...
class Burger extends React.Component {
  ...
  handleClick(){
      document.getElementById('hamburger').classList.toggle('is-closed');
      document.getElementById('inputOverlay').classList.toggle('byeBye');
  }

	render(){
		return (
			<div id="hamburger" className="hamburglar is-open" onClick={this.handleClick}>
        	<div id="top"></div>
